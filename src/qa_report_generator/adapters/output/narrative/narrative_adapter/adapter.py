...
class NarrativeAdapter(NarrativeGenerator):
    ...
    def generate(self, section_prompt: SectionPrompt, user_prompt: str) -> str | None:
        ...
        try:
            ...
            self._log_token_usage(section_label, system_prompt_clean, user_prompt_clean)
    ...
    def _log_token_usage(self, section_label: str, system_prompt: str, user_prompt: str) -> None:
