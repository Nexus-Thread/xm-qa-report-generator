...
from qa_report_generator.adapters.output.parsers.performance import K6JsonParser, K6SummaryTableParser
from qa_report_generator.adapters.output.parsers.pytest_json_parser import PytestJsonParser as PytestJsonParserLegacy

__all__ = ["K6JsonParser", "K6SummaryTableParser", "PytestJsonParser"]
