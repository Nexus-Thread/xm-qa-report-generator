"""Tradinghistoricaldata service extraction definition."""
...
from .schema import TradinghistoricaldataExtractedMetrics

SERVICE_DEFINITION = ServiceDefinition(
    name="tradinghistoricaldata",
    schema_model=TradinghistoricaldataExtractedMetrics,
